...
* **os**:
  * Added two new methods: `os.getPriority` and `os.setPriority`, allowing to
    manipulate the scheduling priority of processes. [#22394](https://github.com/nodejs/node/pull/22394)
* **process**:
...
* **src**:
  * Deprecated option variables in public C++ API. [#22392](https://github.com/nodejs/node/pull/22392)
...
* [[`ff8fadc8b2`](https://github.com/nodejs/node/commit/ff8fadc8b2)] - **build**: enabling pgo at configure (Octavian Soldea) [#21596](https://github.com/nodejs/node/pull/21596)
...
* [[`221ce6cc02`](https://github.com/nodejs/node/commit/221ce6cc02)] - **deps**: cherry-pick e1a7699 from upstream V8 (Camillo Bruni) [#22390](https://github.com/nodejs/node/pull/22390)
* [[`0fde4e9cd1`](https://github.com/nodejs/node/commit/0fde4e9cd1)] - **deps**: cherry-pick 9eb96bb from upstream V8 (Timothy Gu) [#22390](https://github.com/nodejs/node/pull/22390)
...
* [[`983b578913`](https://github.com/nodejs/node/commit/983b578913)] - **src**: implement query callbacks for vm (Timothy Gu) [#22390](https://github.com/nodejs/node/pull/22390)
